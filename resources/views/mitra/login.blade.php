...
<head>
  ...
  <title>LCleaned | Log in Mitra</title>
...
<div class="login-box">
  ...
  <div class="card" style ="position: relative; left: 60%">
    <div class="card-body login-card-body">
      <p style="color: #22bdff" class="login-box-msg">Selamat Datang !</p>
      ...
      <div class="row" style="margin-top: 30px;">
        ...
        <p class="col-6">  
          <a style="color: #22bdff;" href="/mitra/register" class="">Registrasi Akun Baru</a>
        </p>
        <p class="col-6">  
          <a style="color: #22bdff;" href="/login"class="">Kembali</a>
        </p>
      </div>
